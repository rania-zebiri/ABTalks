  ...
  const badges = [
    {
      ...
      color: "text-github bg-github/10 border-github/30",
      locked: false,
    },
    { id: 2, name: "7-Day Streak", icon: <Flame className="w-6 h-6" />, color: "text-primary bg-primary/10 border-primary/30", locked: false },
    {
      id: 3,
      name: "LinkedIn Post",
      icon: (
      ...
      color: "text-linkedin bg-linkedin/10 border-linkedin/30",
      locked: false,
    },
